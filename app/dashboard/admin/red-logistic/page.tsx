...
export default function RedLogisticPage() {
  ...
  const loadData = async () => {
    try {
      ...
      const [ordersData, statsData] = await Promise.all([
        mockApi.getRedLogisticOrders(filters),
        mockApi.getRedLogisticStats(),
      ]);
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600">Gestión de envíos y seguimiento de pedidos</p>
        </div>
        <Button asChild>
          <Link href="/dashboard/admin/red-logistic/create">
                    ...
                    <td className="py-3 px-4">
                      <div className="flex gap-2">
                        <Button variant="outline" size="sm" asChild>
                          <Link href={`/dashboard/admin/red-logistic/${order.id}`}>
