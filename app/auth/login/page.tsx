...
const demoUsers = [
  ...
  { email: 'tienda@paramachoscr.com', role: 'Tienda - PARA MACHOS CR', password: 'ParaMachos1234' },
  { email: 'tienda@otrastiendas.cr', role: 'Tienda - OTRAS TIENDAS', password: 'OtrasTiendas1234' },
